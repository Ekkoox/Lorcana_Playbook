...
export const TRADS = {
  fr: {
    ...
    winratesTitre: 'Taux de victoire par matchup',
    statsTitre: 'Statistiques',
    importDuelsInkTitre: 'Importer depuis Duels.ink',
    importDuelsInkAide: 'Tes listes jouées cette semaine. Un clic remplit le formulaire et lie le deck à tes statistiques.',
    voirTousDecks: 'Voir aussi les listes plus anciennes',
    voirMoinsDecks: 'Masquer les listes plus anciennes',
    lierDeckLabel: 'Deck Duels.ink lié',
    lierDeckAucun: 'Aucun — statistiques par bicolorité',
    winratesSource: 'Basé sur tes parties Duels.ink. Données privées, visibles de toi seul.',
    winratesSourceMeta: 'Statistiques communautaires de Duels.ink —',
    sourcePerso: 'Mes parties',
    sourceMeta: 'Meta global',
    donneesDu: 'données du',
    profilTitre: 'Profil & données personnelles',
    duelsinkTitre: 'Compte Duels.ink',
    duelsinkPasConnecte: "Connecte ton compte Duels.ink pour voir tes propres statistiques et importer tes decks.",
    duelsinkConnecterCompte: 'Connecter mon compte Duels.ink',
    duelsinkConnecte: 'Connecté',
    duelsinkAide: "Pour voir tes propres statistiques et importer tes decks, relie ton compte Duels.ink. Deux minutes, une seule fois.",
    duelsinkEtape1: 'Ouvre',
    duelsinkEtape2: 'Descends jusqu\'à « API Tokens » et clique sur « Create a new token » (nomme-le Loremasters).',
    duelsinkEtape3: 'Copie le jeton affiché et colle-le ci-dessous : la connexion se fait automatiquement.',
    duelsinkJetonInvalide: 'Ce jeton ne ressemble pas à un jeton Duels.ink (96 caractères). Vérifie que tu l\'as copié en entier.',
    duelsinkPlaceholder: 'Jeton Duels.ink (96 caractères)',
    duelsinkConnecter: 'Connecter',
    duelsinkDeconnecter: 'Déconnecter',
    duelsinkDeconnecterConfirme: 'Déconnecter ton compte Duels.ink ? Ton jeton et tes statistiques personnelles seront supprimés.',
    duelsinkSynchroniser: 'Synchroniser maintenant',
    duelsinkSynchroEnCours: 'Synchronisation…',
    duelsinkDerniereSynchro: 'Dernière synchronisation :',
    duelsinkJamaisSynchro: 'Pas encore synchronisé.',
    partiesImportees: 'parties importées.',
    ...
    rgpdTexte: 'Loremasters stocke uniquement : ton identifiant Discord (pseudo, avatar, e-mail fournis par Discord), tes decks, tes plans de jeu et, si tu l\'as connecté, ton jeton Duels.ink en lecture seule. Ces données servent seulement à faire fonctionner l\'application, ne sont jamais partagées ni utilisées à d\'autres fins, et tu peux les exporter ou les supprimer à tout moment ci-dessous.',
  ...
  en: {
    ...
    deconnexion: 'Log out',
    winratesTitre: 'Win rate by matchup',
    statsTitre: 'Stats',
    importDuelsInkTitre: 'Import from Duels.ink',
    importDuelsInkAide: 'Your lists played this week. One click fills the form and links the deck to your stats.',
    voirTousDecks: 'Also show older lists',
    voirMoinsDecks: 'Hide older lists',
    lierDeckLabel: 'Linked Duels.ink deck',
    lierDeckAucun: 'None — stats by ink pair',
    winratesSource: 'Based on your Duels.ink games. Private data, visible only to you.',
    winratesSourceMeta: 'Community statistics from Duels.ink —',
    sourcePerso: 'My games',
    sourceMeta: 'Global meta',
    donneesDu: 'data from',
    profilTitre: 'Profile & personal data',
    duelsinkTitre: 'Duels.ink account',
    duelsinkPasConnecte: 'Connect your Duels.ink account to see your own statistics and import your decks.',
    duelsinkConnecterCompte: 'Connect my Duels.ink account',
    duelsinkConnecte: 'Connected',
    duelsinkAide: 'To see your own statistics and import your decks, link your Duels.ink account. Two minutes, once.',
    duelsinkEtape1: 'Open',
    duelsinkEtape2: 'Scroll to "API Tokens" and click "Create a new token" (name it Loremasters).',
    duelsinkEtape3: 'Copy the token and paste it below: the connection happens automatically.',
    duelsinkJetonInvalide: "This doesn't look like a Duels.ink token (96 characters). Check that you copied all of it.",
    duelsinkPlaceholder: 'Duels.ink token (96 characters)',
    duelsinkConnecter: 'Connect',
    duelsinkDeconnecter: 'Disconnect',
    duelsinkDeconnecterConfirme: 'Disconnect your Duels.ink account? Your token and personal statistics will be deleted.',
    duelsinkSynchroniser: 'Sync now',
    duelsinkSynchroEnCours: 'Syncing…',
    duelsinkDerniereSynchro: 'Last sync:',
    duelsinkJamaisSynchro: 'Not synced yet.',
    partiesImportees: 'games imported.',
    ...
    rgpdTexte: 'Loremasters only stores: your Discord identity (username, avatar, e-mail provided by Discord), your decks, your game plans and, if you connected it, your read-only Duels.ink token. This data is used solely to run the app, is never shared or used for anything else, and you can export or delete it at any time below.',

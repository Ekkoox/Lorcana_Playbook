...
export const TRADS = {
  fr: {
    ...
    duelsinkAide: "Colle un jeton d'API (lecture seule) pour voir tes propres statistiques et importer tes decks. Crée-le depuis ton compte :",
  ...
  en: {
    ...
    duelsinkAide: 'Paste a read-only API token to see your own statistics and import your decks. Create one from your account:',
